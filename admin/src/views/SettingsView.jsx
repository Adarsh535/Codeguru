      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-metoxi flex flex-col gap-4">
        <div className="flex items-center justify-between border-b border-slate-100 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">MongoDB Compass Server & REST API Endpoint</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-semibold">
          <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 flex flex-col gap-1">
            ...
            <span className="text-slate-800 font-mono font-bold">mongodb://127.0.0.1:27017/codeguru_db</span>
          </div>
          <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 flex flex-col gap-1">
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-metoxi flex flex-col gap-5">
        <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Change Admin email address or login password stored in MongoDB</p>
          </div>
        </div>
